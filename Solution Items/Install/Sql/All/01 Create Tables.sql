...
CREATE INDEX idx_person_addressId ON person(addressId);
...
CREATE UNIQUE INDEX idx_commonMeal_data ON commonMeal(date);

CREATE TABLE commonMealRegistration (
	id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
