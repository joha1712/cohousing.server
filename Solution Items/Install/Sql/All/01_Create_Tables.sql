...
CREATE TABLE IF NOT EXISTS commonMealGuestRegistration (
	id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	registrationId INT REFERENCES commonMealRegistration(id) NOT NULL,
	data TEXT COLLATE "da-DK-x-icu" NOT NULL
);
